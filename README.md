...
2. Open this project folder (`path to repo`) in Godot.
...
- `Main.tscn` with basic environment/litighting
- Basic debug logging via `DebugLog`

## Input actions (configured in Phase 0)
...
scripts/    core (game loop), simulation, planet, celestial, impacts, ui, debug
shaders/    shader code
